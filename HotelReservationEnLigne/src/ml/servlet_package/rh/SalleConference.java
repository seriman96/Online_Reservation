...
@WebServlet("/SalleConference")
public class SalleConference extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(recue.equals("Reserver")) {
			try {
				...
				Tarif trf = new Tarif();
				String type = "salle de conférence";//request.getParameter("type")
				trf.setTypeS(type);
				trf.setPrixJS();
				//try {
			...
			request.setAttribute("donneAppart", acces.sortieSalle("salle de conférence"));
