...
@WebServlet("/SingleAppart")
public class SingleAppart extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/Single.jsp").forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(recue.equals("Reserver")) {
			try {
				...
				Tarif trf = new Tarif();
				String type = "SINGLE APPART";//request.getParameter("type")
				trf.setTypeA(type);
				trf.setPrixJ();
				//try {
			...
			request.setAttribute("donneAppart", acces.sortieAppart("SINGLE APPART"));
