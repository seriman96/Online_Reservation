...
<html>
	...
	<body>
		...
		<center><h1 style="color:lime">RESERVATION Salle de conférence</h1></center>
		...
		<form method="post" action="Conference">
			...
			<fieldset id="fiel2">
				...
				<select name="type" id="typ" disabled="disabled">
					<option value="salle de conférence" selected="selected">Salle de conférence</option>
				</select><br>
			...
			<input name="fin" type="text" id="fi" placeholder="02-janvier-2019" required="required"><br>
