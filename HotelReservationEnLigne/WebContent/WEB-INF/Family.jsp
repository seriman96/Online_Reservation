...
<html>
	...
	<body>
		...
		<center><h1 style="color:lime">reservation FAMILLY APPART</h1></center>
		<center>
		<h2 class="infoC">Formulaire de Reservation</h2>
		<fieldset id="fiels1">
		<form method="post" action="Family" name="form1">
			<fieldset id="fiel1">
				...
				<input name="email" type="text" id="ema"><br>
			...
			<fieldset id="fiel2">
				...
				<select name="type" id="typ" disabled="disabled">
					<option value="FAMILLY APPART" selected="selected">FAMILLY APPART</option>
				</select><br>
				...
				<input name="fin" type="text" id="fi" placeholder="03-janvier-2019" required="required"><br>
