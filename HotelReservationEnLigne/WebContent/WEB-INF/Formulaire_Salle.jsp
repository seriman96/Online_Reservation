...
<html>
	...
	<body>
		...
		<center><h1 style="color:lime">  RESERVATION SALLE </h1></center>
		...
		<form method="post" action="FormulaireS">
			...
			<fieldset id="fiel2">
				...
				<label for="Ltrs">Type de salle à reserver:</label>
				<select name="type" id="typ">
					<option value="salle de conférence">Salle de conférence</option>
					<option value="salle de réunion">Salle de réunion</option>
					<option value="salle de cérémonie">Salle de cérémonie</option>
				</select><br>
