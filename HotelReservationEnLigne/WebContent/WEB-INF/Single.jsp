...
<html>
	...
	<body>
		...
		<center><h1 style="color:lime">reservation SINGLE APPART</h1></center>
		<center>
		<h2 class="infoC">Formulaire de Reservation</h2>
		<fieldset id="fiels1">
		<form method="post" action="Single" name="form1">
			<fieldset id="fiel1">
			...
			<fieldset id="fiel2">
				...
				<select name="type" id="typ" disabled="disabled">
					<option value="SINGLE APPART" selected="selected">SINGLE APPART</option>
				</select><br>
				...
				<input name="fin" type="text" id="fi" placeholder="05-janvier-2019" required="required"><br>
