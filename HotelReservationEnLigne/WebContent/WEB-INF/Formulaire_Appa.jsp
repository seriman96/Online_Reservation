...
<html>
	...
	<body>
		...
		<center><h1 style="color:lime"> RESERVATION APPART</h1></center>
		
		<center>
		<h2 class="infoC">Formulaire de Reservation</h2>
		<fieldset id="fiels1">
			<form method="post" action="Formulaire" name="form1">
			<fieldset id="fiel1">
			...
			<fieldset id="fiel2">
				...
				<label for="Ltr11">Type d'appartement à reserver:</label>
				<select name="type" id="typ">
					<option value="SINGLE APPART">SINGLE APPART(50_000f/jour)</option>
					<option value="TWINS APPART">TWINS APPART(60_000f/jour)</option>
					<option value="FAMILLY APPART">FAMILLY APPART(70_000f/jour)</option>
				</select><br>
		 ...
		 <!--<ul>
		  	...
		  	<c:forEach var="tab1" items="${ donneClient }" >
		  		<li><c:out value="${ tab1.nomCl}" /> <c:out value="${ tab1.prenomCl }" /></li>
